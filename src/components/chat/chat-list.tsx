...
export function ChatList({ chats, selectedChat, onSelectChat, currentUser }: ChatListProps) {
          ...
          >
            ...
            <div className="flex-1 truncate group-data-[collapsible=icon]:hidden">
              <div className="flex items-center justify-between">
                ...
                <p className="text-xs text-muted-foreground">{chat.lastMessageTimestamp}</p>
              </div>
